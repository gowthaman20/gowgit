...
class LoginWindow(ttk.Frame, ThemeEngine):
    def __init__(self, master):
        ...
        title = ttk.Label(self.bg_frame, text="INVENTORY MANAGEMENT",
                          font="Arial 50 bold", foreground='#22d3fe')
        title.place(x=-150,y=27, relx=0.3)
        title = ttk.Label(self.bg_frame, text="USER LOGIN",
                          font="Arial 40 bold", foreground='#22d3fe')
        title.place(x=80,y=100, relx=0.3)
        ...
        logo_label.place(x=100,y=5, relheight=1)
        ...
        self.username_entry.place(x=700, y=295)
        ...
        self.login_button.place(x=740, y=455)
